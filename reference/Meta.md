...
covariates and the meta-analyzed parameters/effect sizes.
...
- y:
  ...
  A list. Each element of the list is a numeric vector of estimated
  coefficients.

- v:

  A list. Each element of the list is a sampling variance-covariance
  matrix of `y`.
...
[`MetaVARMx()`](https://github.com/jeksterslab/metaDyn/reference/MetaVARMx.md)

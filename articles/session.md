...
#> [4] simStateSpace_1.2.15 
#> 
#> loaded via a namespace (and not attached):
#>  [1] digest_0.6.39         xfun_0.56             Matrix_1.7-4         
#>  [4] lattice_0.22-7        glue_1.8.0            parallel_4.5.2       
#>  [7] knitr_1.51            RcppParallel_5.1.11-2 lifecycle_1.0.5      
#> [10] cli_3.6.5             rProject_0.0.25       vctrs_0.7.1          
#> [13] grid_4.5.2            compiler_4.5.2        tools_4.5.2          
#> [16] evaluate_1.0.5        pillar_1.11.1         Rcpp_1.1.1           
#> [19] otel_0.2.0            rlang_1.1.7           expm_1.0-0           
#> [22] MASS_7.3-65
```
...
## Memory
    ...
    #> Mem:            15Gi       4.3Gi       3.2Gi       498Mi       8.4Gi        10Gi
    #> Swap:          7.8Gi       6.0Mi       7.8Gi
    #> Total:          22Gi       4.3Gi        10Gi

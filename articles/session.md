...
`#> [1] metaDyn_1.0.4        fitVARMxID_1.0.6     OpenMx_2.22.11      `\
...
`#> StanHeaders       "StanHeaders"       "2.39.1"    `\
...
## Memory
    ...
    #> Mem:           7.7Gi       1.3Gi       3.4Gi        11Mi       3.3Gi       6.4Gi
    #> Swap:          2.0Gi       2.5Mi       2.0Gi
    #> Total:         9.7Gi       1.3Gi       5.4Gi

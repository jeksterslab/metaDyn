...
#>  [1] digest_0.6.39         xfun_0.57             Matrix_1.7-5         
#>  [4] lattice_0.22-9        glue_1.8.1            knitr_1.51           
#>  [7] parallel_4.6.0        RcppParallel_5.1.11-2 lifecycle_1.0.5      
#> [10] cli_3.6.6.9000        rProject_0.0.25       vctrs_0.7.3          
#> [13] grid_4.6.0            compiler_4.6.0        tools_4.6.0          
#> [16] pillar_1.11.1         evaluate_1.0.5        Rcpp_1.1.1-1.1       
#> [19] otel_0.2.0            rlang_1.2.0           expm_1.0-0           
#> [22] MASS_7.3-65
```
...
## Memory
    ...
    #> Mem:            44Gi       8.2Gi       6.6Gi        61Mi        30Gi        36Gi
    #> Swap:           22Gi       2.8Mi        22Gi
    #> Total:          66Gi       8.2Gi        29Gi

...
Let $t = 100$ be the number of time points and $n = 1000$ be the number of individuals. We simulate a total of time $= 1.01 &times; 10<sup>4</sup>$ points per individual, discarding the first $10<sup>4</sup>$ as burn-in. The analysis uses the final $100$ measurement occasions.
